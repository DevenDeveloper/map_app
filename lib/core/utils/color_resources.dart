...
import 'package:map_app/data/common/theme_controller.dart';

class ColorResources {
  static const Color primaryColor = Color(0xff270101);
  static const Color secondaryColor = Color(0xff150000);
  ...
  static Color secondaryScreenBgColor = primaryColor.withAlpha(4);
